import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-Bt7jq58k.js";import{t as a}from"./Heading-DaPZub_W.js";import{c as o}from"./Stack-C7dTtCDZ.js";import{t as s}from"./Text-BYms8e3u.js";import{t as c}from"./Divider-CyxlzlSx.js";import{u as l}from"./iframe-Byu_TeJH.js";import{$t as u,Gt as d,Kt as f,Qt as p,Xt as m,Yt as h,Zt as g,en as _,qt as v,t as y,tn as b}from"./src-DLL0xG2k.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L;e((()=>{x=t(n()),y(),l(),s(),S=r(),C={title:`Lab/SVGIcon`,component:b,argTypes:{variation:{control:`select`,options:[`linear`,`bold`,`twotone`,`bulk`,`broken`]},size:{control:`select`,options:[`xsm`,`sm`,`md`,`lg`]},color:{control:`select`,options:[`primary`,`secondary`,`disabled`,`accent`,`positive`,`negative`,`warning`,`inherit`]},strokeWidth:{control:{type:`range`,min:.5,max:4,step:.25}}}},w={args:{icon:d,variation:`linear`,size:`lg`,color:`primary`}},T=[`linear`,`bold`,`twotone`,`bulk`,`broken`],E={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:3,children:[(0,S.jsx)(a,{level:3,children:`Variation Matrix`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`Same SVG paths, different visual treatments via CSS custom properties. Note how stroke-role elements (menu lines, calendar pegs, bell clapper) stay as strokes even in bold/bulk mode.`}),(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`120px repeat(${T.length}, 1fr)`,gap:12,alignItems:`center`},children:[(0,S.jsx)(`div`,{}),T.map(e=>(0,S.jsx)(i,{type:`label`,color:`secondary`,style:{textAlign:`center`},children:e},e)),_.map(e=>(0,S.jsxs)(x.Fragment,{children:[(0,S.jsx)(i,{type:`label`,children:e.name}),T.map(t=>(0,S.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`},children:(0,S.jsx)(b,{icon:e,variation:t,size:`lg`})},`${e.name}-${t}`))]},e.name))]})]})},D={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:3,children:[(0,S.jsx)(a,{level:3,children:`Path Roles: Fill vs Stroke`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`Stroke-role elements always stay as strokes. Fill-role elements switch between stroke (linear) and fill (bold). Compare Menu (all stroke-role) vs Home (fill-role body + fill-role door with mask knockout).`}),(0,S.jsxs)(o,{direction:`vertical`,gap:2,children:[(0,S.jsx)(i,{type:`label`,color:`secondary`,children:`Menu — all stroke-role (lines never become fills)`}),(0,S.jsx)(o,{direction:`horizontal`,gap:3,children:T.map(e=>(0,S.jsxs)(o,{direction:`vertical`,gap:.5,hAlign:`center`,children:[(0,S.jsx)(b,{icon:g,variation:e,size:`lg`}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e})]},e))}),(0,S.jsx)(c,{}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:`Home — fill-role body + door (mask gap in bold)`}),(0,S.jsx)(o,{direction:`horizontal`,gap:3,children:T.map(e=>(0,S.jsxs)(o,{direction:`vertical`,gap:.5,hAlign:`center`,children:[(0,S.jsx)(b,{icon:v,variation:e,size:`lg`}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e})]},e))}),(0,S.jsx)(c,{}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:`Settings — fill-role gear + circle (mask gap in bold)`}),(0,S.jsx)(o,{direction:`horizontal`,gap:3,children:T.map(e=>(0,S.jsxs)(o,{direction:`vertical`,gap:.5,hAlign:`center`,children:[(0,S.jsx)(b,{icon:u,variation:e,size:`lg`}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e})]},e))})]})]})},O=[`xsm`,`sm`,`md`,`lg`],k={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:2,children:[(0,S.jsx)(a,{level:3,children:`Size Scale with Optical Compensation`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`Stroke width auto-adjusts at smaller sizes for legibility.`}),(0,S.jsx)(o,{direction:`horizontal`,gap:3,vAlign:`end`,children:O.map(e=>(0,S.jsxs)(o,{direction:`vertical`,gap:1,hAlign:`center`,children:[(0,S.jsx)(b,{icon:u,variation:`linear`,size:e}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e})]},e))})]})},A=[`primary`,`secondary`,`disabled`,`accent`,`positive`,`negative`,`warning`],j={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:2,children:[(0,S.jsx)(a,{level:3,children:`Semantic Colors`}),(0,S.jsx)(o,{direction:`horizontal`,gap:3,children:A.map(e=>(0,S.jsxs)(o,{direction:`vertical`,gap:1,hAlign:`center`,children:[(0,S.jsx)(b,{icon:d,variation:`linear`,size:`lg`,color:e}),(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e})]},e))})]})},M=[v,u,f,p,m,h],N={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:3,children:[(0,S.jsx)(a,{level:3,children:`Mask Gaps on Different Backgrounds`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`Bold mode uses mask-based knockout gaps. Because the gap is transparent (not white), it works on any background: solid colors, surfaces, and gradients alike.`}),[{label:`White`,bg:`#ffffff`},{label:`Surface`,bg:`#f5f5f5`},{label:`Accent`,bg:`#0066ff`},{label:`Gradient`,bg:`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`}].map(({label:e,bg:t})=>(0,S.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,S.jsx)(i,{type:`label`,color:`secondary`,children:e}),(0,S.jsx)(`div`,{style:{background:t,padding:16,borderRadius:8,display:`flex`,gap:16},children:M.map(t=>(0,S.jsx)(b,{icon:t,variation:`bold`,size:`lg`,color:e===`White`||e===`Surface`?`primary`:`inherit`,style:e===`Accent`||e===`Gradient`?{color:`#ffffff`}:void 0},t.name))})]},e))]})},P=[1,1.5,2,2.5,3],F={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:3,children:[(0,S.jsx)(a,{level:3,children:`Stroke Width Range`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`Linear mode at stroke widths from 1 to 3. Thinner strokes feel lighter and more refined; thicker strokes add visual weight.`}),(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`80px repeat(${P.length}, 1fr)`,gap:12,alignItems:`center`},children:[(0,S.jsx)(`div`,{}),P.map(e=>(0,S.jsx)(i,{type:`label`,color:`secondary`,style:{textAlign:`center`},children:e},e)),_.slice(0,8).map(e=>(0,S.jsxs)(x.Fragment,{children:[(0,S.jsx)(i,{type:`label`,children:e.name}),P.map(t=>(0,S.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`},children:(0,S.jsx)(b,{icon:e,variation:`linear`,size:`lg`,strokeWidth:t})},`${e.name}-${t}`))]},e.name))]})]})},I={render:()=>(0,S.jsxs)(o,{direction:`vertical`,gap:3,children:[(0,S.jsx)(a,{level:3,children:`Structural Diversity`}),(0,S.jsx)(i,{type:`supporting`,color:`secondary`,children:`New icons with diverse structures: organic curves, complex single paths, nested overlapping fills, and mixed fill+stroke roles, across all five variations.`}),(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`120px repeat(${T.length}, 1fr)`,gap:12,alignItems:`center`},children:[(0,S.jsx)(`div`,{}),T.map(e=>(0,S.jsx)(i,{type:`label`,color:`secondary`,style:{textAlign:`center`},children:e},e)),_.slice(7).map(e=>(0,S.jsxs)(x.Fragment,{children:[(0,S.jsx)(i,{type:`label`,children:e.name}),T.map(t=>(0,S.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`},children:(0,S.jsx)(b,{icon:e,variation:t,size:`lg`})},`${e.name}-${t}`))]},e.name))]})]})},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    icon: bellIcon,
    variation: 'linear',
    size: 'lg',
